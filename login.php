...
<nav class="w3-sidebar w3-bar-block w3-light-grey w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="#start" onclick="w3_close()" class="w3-bar-item w3-button">PortPulse</a>
...
<div class="container py-5 h-100">
	...
	<div class="col-md-6 col-lg-5 d-none d-md-block">
		<img src="images/login.jpg" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; height: 500px;">
	</div>
	<div class="col-md-6 col-lg-7 d-flex align-items-center">
	<div class="card-body p-4 p-lg-5 text-black">
	
	<h3>LOGIN</h3>
	<form method="POST" action="login.php" class="was-validated">
...
function w3_open() {
  if (open_sidebar.style.display === 'block') {
