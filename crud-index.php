        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown">Customer</a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="create.php">Add Customer</a></li>
              <li><a class="dropdown-item" href="crud-index.php">Customer Reports</a></li>
            </ul>
        </li>
...
<!-- Dashboard of CRUD for Admin Profile Details -->
          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="mt-5 mb-3 clearfix">
                      <h1 class="pull-left">ADMIN PROFILE DETAILS</h1>
                      <a href="register.php" class="button pull-right"><i class="fa fa-plus"></i> Add New Admin</a>
                  </div>
